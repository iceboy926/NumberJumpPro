...
@interface SISinusWaveView : UIView {
...
@property (copy) IBInspectable UIColor *waveColor;
...
@property (copy) IBInspectable UIColor *backgroundColor;
...
- (UIColor *) colorForLineAtLocation: (CGFloat) location percentalLength: (CGFloat) length;
